...
const tenantTables=[
  ...
  "accreditation_agencies","accreditation_frameworks","accreditation_clusters","accreditation_criteria","accreditation_indicators","accreditation_indicator_variables","accreditation_scoring_rubrics","accreditation_indicator_clusters","accreditation_evidence_requirements","study_program_accreditation_frameworks","accreditation_indicator_mandates","accreditation_assessments","accreditation_assessment_values","accreditation_assessment_sources"
] as const;
