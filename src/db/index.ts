...
import * as evaluationModuleSchema from "./schema-evaluation-modules";
...
const schema={...coreSchema,...adminSchema,...phase5Schema,...phase6Schema,...phase6PublicationSchema,...accreditationSchema,...masterSchema,...evaluationModuleSchema};
