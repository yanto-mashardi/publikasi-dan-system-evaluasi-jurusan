...
const input=z.object({subjectType:z.enum(["STRATEGIC_STATEMENT","KPI_MEASUREMENT","EVALUATION","NEWS_ARTICLE"]),subjectId:z.number().int().positive(),publicTitle:z.string().optional(),publicSummary:z.string().optional()});
