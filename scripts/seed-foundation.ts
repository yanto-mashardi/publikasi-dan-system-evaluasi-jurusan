...
const ROLE_GRANTS:Record<string,string[]>={
 ...
 ADMIN_DATA:["data.create","data.update","evidence.upload","publication.execute","news.manage","internal.read","resources.read","resources.manage","accreditation.read","accreditation.assess"],
